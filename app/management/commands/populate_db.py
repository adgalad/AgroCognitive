...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        user = User.objects.filter(email="admin@admin.com")[0]
        company = Company(name="Jops", rif="J123123")
        company.save()
        user.company = company
        user.save
        t = Terrain(city="Caracas",
                    country="Venezuela",
                    coordinates="10°11'45.9\"22N,68°58'12.8\"22W",
                    name="La hacienda",
                    is_active=True,
                    owned_by=company)
        t.save()
        c = Crop(tipo="Caña azucar",
                 variety="B4234",
                 name="El tablon de azucar",
                 inside_of=t)
        c.save()
